...
AC_OBJS = AC.o ACSettingsFile.o ACConfigFile.o \
	ACMainLoop.o ACDiscoveryState.o ACJoinState.o \
	ACConfigureState.o ACDataCheckState.o ACRunState.o ACProtocol_User.o \
	ACRetransmission.o \
	ACMultiHomedSocket.o ACProtocol.o \
	CWVendorPayloadsAC.o \
...
WTP_OBJS = WTP.o WTPSettingsFile.o WTPConfigFile.o \
	WTPFrameReceive.o WTPFreqStatsReceive.o WTPStatsReceive.o WTPProtocol.o WTPProtocol_User.o \
	WTPDiscoveryState.o WTPJoinState.o WTPConfigureState.o WTPDataCheckState.o WTPRunState.o WTPRunStateCheck.o \
	WTPRetransmission.o WTPSulkingState.o \
	CWVendorPayloadsWTP.o WTPBinding.o \
	WTPDriverInteraction.o \
	WTPRadio.o WTPNL80211DriverCallback.o WTPNL80211Driver.o WTPNL80211Netlink.o WTPIEEEConfigurationState.o CW80211ManagementFrame.o
WTP_OBJS += $(_COM_OBJS)
WTP_OBJS += $(_CW_OBJS)

# list of generated object files for WUA.
WUA_OBJS = WUA.o
